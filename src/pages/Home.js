...
import SimpleImageSlider from "react-simple-image-slider";
 ...
 const  Home = () =>  {
	...
	const getMags = async () => {
		try {
		  const response = await axios.get(`${base_url}mag_api`);
	...
	// console.log(mag)
	const images = [
		{ url: "https://stories.jobaaj.com/jobaajtimes/flipbook/2023-11/1.png" },
	];
	useEffect(() => {
		console.log('mag:', mag);
	}, [mag]);
  const toMag = () => {
    window.open('https://stories.jobaaj.com/jobaajtimes/', '_blank');
  };
                ...
                <div className="col-sm-6">
                  <div className="post">
                    ...
                    <h5 className="post-title mb-3 mt-3">
                      <a href={`/${castories1.url}`}>{castories1.title}</a>
                    </h5>
                ...
                <div className="col-sm-6">
                  {castories.length > 0
                    ? castories
                        .slice(1)
                        .map((item) => (
                          <Blog key={item.id} blog={item} type={0} />
                        ))
                    : "No Post"}
                </div>
              </div>
              ...
              <div className="row">
                {mail.length > 0
                  ? mail
                      .slice()
                      .map((item) => (
                        <Blog key={item.id} blog={item} type={6} />
                      ))
                  : "No Post"}
              </div>
            </div>
              ...
              <div className="row">
                {learn.length > 0
                  ? learn
                      .slice(1, 6)
                      .map((item) => (
                        <Blog key={item.id} blog={item} type={3} />
                      ))
                  : "No Post"}
              </div>
